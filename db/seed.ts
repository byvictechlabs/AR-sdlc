    ...
    const steps = [
      {
        ...
        content: "Pada tahap Requirement, tim bekerja sama dengan Product Owner dan stakeholder untuk mengumpulkan serta memprioritaskan kebutuhan pengguna. Hasil dari tahap ini adalah Product Backlog yang berisi daftar kebutuhan (user stories) yang akan dikerjakan dalam sprint-sprint mendatang. Tim memastikan setiap kebutuhan memiliki kriteria penerimaan yang jelas sebelum masuk ke tahap desain.",
        imageUrl: null,
        audioUrl: null,
        stepOrder: 1,
      },
      {
        ...
        content: "Tahap Design berfokus pada perancangan arsitektur dan desain teknis untuk setiap user story yang akan dikerjakan. Tim mendiskusikan pendekatan teknis, membuat sketsa antarmuka, dan menentukan struktur data yang sesuai. Desain yang dihasilkan cukup detail untuk memandu implementasi namun tetap fleksibel terhadap perubahan yang mungkin muncul selama pengembangan.",
        imageUrl: null,
        audioUrl: null,
        stepOrder: 2,
      },
      {
        ...
        content: "Pada tahap Development, para developer mulai menulis kode program untuk setiap user story yang telah didesain. Pengembangan dilakukan secara iteratif dengan siklus sprint yang pendek (biasanya 1-4 minggu). Setiap fitur dikerjakan hingga selesai termasuk unit testing dan code review sebelum dianggap siap untuk tahap pengujian.",
        imageUrl: null,
        audioUrl: null,
        stepOrder: 3,
      },
      {
        ...
        content: "Tahap Testing meliputi berbagai jenis pengujian seperti unit testing, integration testing, dan acceptance testing. Tim QA bekerja sama dengan developer untuk memastikan setiap fitur berfungsi sesuai kriteria penerimaan. Bug yang ditemukan dicatat dan diperbaiki dalam sprint yang sama sebelum fitur dianggap selesai (done).",
        imageUrl: null,
        audioUrl: null,
        stepOrder: 4,
      },
      {
        ...
        content: "Tahap Deployment meliputi proses rilis fitur-fitur yang telah selesai diuji ke lingkungan produksi. Tim menggunakan praktik CI/CD untuk mengotomatiskan proses build, pengujian, dan deployment. Setiap rilis dilakukan secara bertahap untuk meminimalkan risiko dan memungkinkan rollback cepat jika terjadi masalah.",
        imageUrl: null,
        audioUrl: null,
        stepOrder: 5,
      },
